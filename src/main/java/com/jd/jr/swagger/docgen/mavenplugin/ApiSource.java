package com.jd.jr.swagger.docgen.mavenplugin;
...
public class ApiSource {
	 ...
	 * packages containing those classes can be configured here, use ; as the
	 * delimiter if you have more than one location.
	 */
	 ...
	 */
	@Parameter
	private String yapiUserCredentialsDirectory;
	...
	public String getYapiUserCredentialsDirectory() {
		return yapiUserCredentialsDirectory;
	}

	public void setYapiUserCredentialsDirectory(String yapiUserCredentialsDirectory) {
		this.yapiUserCredentialsDirectory = yapiUserCredentialsDirectory;
	}
